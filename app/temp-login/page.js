...
export default function AdminLoginPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#f8f9fa", fontFamily: "'Pretendard', sans-serif" }}>
      ...
      {/* ⭐ 메인: margin을 조절하여 카드를 위로 올림 */}
      <main style={{ padding: "20px", maxWidth: "450px", margin: "20px auto 0", boxSizing: "border-box" }}>
        <div style={{ backgroundColor: "white", borderRadius: "24px", padding: "40px 20px", boxShadow: "0 10px 30px rgba(0,0,0,0.05)", textAlign: "center", boxSizing: "border-box" }}>
